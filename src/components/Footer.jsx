...
//         <div>
//           <div className="vect1 d-flex justify-content-center">
//             <img src={vect} alt="" />
//           </div>
//         </div>
//         <div className="percent">
//           <h1 className="">100%</h1>
//           <h3 className="">Payment Secured</h3>
//         </div>

//         <div>
//           <div className="vect d-flex  justify-content-center mt-4">
//             <img src={vect1} alt="" />
//             <img src={vect2} alt="" />
//           </div>

//           <div className="d-flex justify-content-center">
//             <h1 className="twenty d-flex justify-content-center">24/7</h1>
//             <h1 className="support d-flex justify-content-center">support</h1>
//           </div>
//         </div>
//         <div></div>
...
//           <div className="link">
//             <a href="tel:+234 466 6655">tel:+234 466 6655 or</a>
//           </div>
//           <div className="link">
